    ...
    var fxa = function(a) {
        ...
        Exa = function(a) {
            ...
            (b = a.th({
                ...
                ni: c,
                wi: d
            })) ? (b = (new _.zv(_.Fna(a.sh, b))).dv("x", b.li).dv("y", b.ni).dv("z",
                g), e !== 1 && b.dv("w", a.Ci.size.Xh / e), f && (e *= 2), e !== 1 && b.dv("scale", e), a.qh.setUrl(b.toString()).then(a.jn)) : a.qh.setUrl("").then(a.jn)
        },
        HD = function(a, b, c, d = {
            Sl: null
        }) {
        ...
        Rxa = function(a, b, c, d, e) {
            ...
            if (a.map.__gm.zh.tA(b, c, !!d && !!d.touches || f || g)) d && e && _.Wt(e) && _.Fm(d);
            else {
        ...
        OD = function(a, b, c) {
            function d() {
                var k = a.__gm,
                    m = k.get("baseMapType");
                m && !m.nw && (a.getTilt() !== 0 && a.setTilt(0), a.getHeading() !== 0 && a.setHeading(0));
                var p = OD.cN(a.getDiv());
                p.width -= e;
                p.width = Math.max(1, p.width);
                p.height -= f;
                p.height = Math.max(1, p.height);
                m = a.getProjection();
                p = OD.dN(m, b, p, a.get("isFractionalZoomEnabled"));
                var q =
                    a.get("maxZoom") || 22;
                p > q && (p = q);
                var u = OD.jN(b, m);
        ...
        hya = function(a) {
            switch (a.mapTypeId) {
                case "roadmap":
                    return 149879;
                case "satellite":
                    return a.nw ? 149882 : 149880;
                case "hybrid":
                    return a.nw ? 149882 : 149877;
                case "terrain":
                    return 149881;
                default:
                    return 149878
        ...
        jya = function(a, b) {
            return b.find(c => a <= c.threshold) ? .El
        },
                ...
                if (e = a.sh = _.Fl(e) && f && g ? `${g}|${e}` : null) {
                    if ((d =
                        ...
                        if (_.Fl(f) && _.Fl(g)) {
                            ...
                            (f = a.get("baseMapType")) && f.Jw && a.th && _.fh(e, 6, f.Jw);
                            a.rh = vxa(b, 1, 10);
                            b =
                                a.rh;
                            f = _.wg(e, _.vA, 1);
                            ...
                            a.wh ? (a.wh = !1, b = _.hh(e, 12, 1).setUrl(a.Eh.substring(0, 1024)), _.Yg(b, 14, !0), a.map.yE || (b = e, f = _.Zt(_.Yt(), a.map).toString(), _.fh(b, 17, f))) : _.hh(e, 12, 2);
                            b = e;
                            try {
                                let p = await Jya(a, b),
                                    q = a.map.__gm.Dh,
...
"\u00a0":""}` : "", a.xh || a.Ih.tv(b, c))
        ...
        Vya = function(a, b = !1) {
            ...
            a.nv.textContent = b ? c : "Use two fingers to move the map";
        ...
        Yya = function(a, b) {
            if (!_.Wt(b)) {
                ...
                if (c !== !1) {
                    ...
                    c = a.xh(d ? 1 : 4);
                    if (c !== "none" && (c !== "cooperative" || !d) && (_.Dm(b), d = a.Sh.tm())) {
                        var e = (b.deltaY || b.wheelDelta || 0) * (b.deltaMode === 1 ? 16 : 1),
                            f = a.wh();
                        !f && (e > 0 && e < a.rh || e < 0 && e > a.rh) ? a.rh = e : (a.rh = e, a.qh += e, a.th.tv(), !f && Math.abs(a.qh) < 16 || (f ? (Math.abs(a.qh) > 16 && (a.qh = _.Iv(a.qh < 0 ? -16 : 16, a.qh, .01)), e = -(a.qh / 16) / 5) : e = -Math.sign(a.qh), a.qh = 0, b = c === "zoomaroundcenter" ?
                            d.center : a.Sh.An(b), f ? a.Sh.EK(e, b) : (c = Math.round(d.zoom + e), a.sh !== c && (Xya(a.Sh, c, b, () => {
                                a.sh = null
                            }), a.sh = c)), a.No(1)))
                    }
                }
                ...
                Pl({
                    ...
                    if (z) {
                        ...
                        if (z.enabled() && (x = z.rh(4), x !== "none")) {
                            var L = z.Sh.tm();
                            L && (B = L.zoom + (B ? -1 : 1), z.qh() || (B = Math.round(B)), u = x === "zoomaroundcenter" ? z.Sh.tm().center :
        ...
        eE = function(a) {
            a.xh || (a.xh = !0, a.requestAnimationFrame(b => {
                ...
                if (a.instructions) {
                    ...
                    c ? a.camera = c = a.qh.Dw(c) : c = a.camera;
                    c && (e === 0 && a.th ? jza(a.ei, c, b, !1) : (a.ei.ti(c, b, d.Il), e !== 1 && e !== 0 || eE(a)));
                    c && !d.Il && a.sh(c)
        ...
        jza = function(a, b, c, d) {
            ...
            a.options.lB || (a.sh.style.willChange = a.th.style.willChange = "");
        ...
        Uza = function(a, b, c, d, e) {
            ...
            function g() {
                ...
                Ea ? (a.bindTo("svClient", Ea, "client"), Ea.__gm.bindTo("fontLoaded", ee)) : (a.unbind("svClient"),
                    a.set("svClient", null))
            }
            ...
            function h() {
                ...
                if (bc !== Ea || cb !== ab) {
                    ...
                    kc.update();
                    var zb = z.qh;
                    Ea <= 0 || ab <= 0 || ((Ea = jya(Ea, yza)) && _.M(zb, Ea), (ab = jya(ab, zza)) && _.M(zb, ab))
                }
            }
            var k = _.fl.rh().rh(),
                m = a.__gm,
            ...
            var q = new Promise(Ea => {
                    var ab = _.Rm(a, "bounds_changed", async () => {
                        var zb = a.get("bounds");
                        zb && !_.Uu(zb).equals(_.Tu(zb)) && (ab.remove(), await 0, m.set("mapHasBeenAbleToBeDrawn", !0), Ea())
                    })
                }),
                u = a.getDiv();
            if (u)
                if (Array.from(new Set([42]))[0] !== 42) _.joa(u);
                    ...
                    m.set("configVersion", "");
                    m.Jh = new Aza(c);
                    m.Jh.Nh = z.mn.overlayMouseTarget;
                    m.pi = () => {
                    ...
                    (() => {
                        var Ea = new Eza;
                        ha = gya(Ea, La, a, Ra, Ma);
                        Ga = new Fza(k, A, ia, Ra ? null : Ea, _.cw(), Db, a)
                    })();
                    Ga.bindTo("tilt", a);
                    Ga.bindTo("heading", a);
                    Ga.bindTo("bounds", a);
                    ...
                    var xb = _.On(!1),
                        Na = pya(a, xb);
                    Ga.bindTo("baseMapType", Na);
                    b = m.Cv = Na.xh;
                    var eb = _.Goa({
                            draggable: new _.XA(a, "draggable"),
                            hH: new _.XA(a, "gestureHandling"),
                            Nl: m.en,
                            Ar: a.getDiv()
                        }),
                        Cc = !_.pp[20] || a.get("animatedZoom") !== !1,
                        ac = null,
                        gd = !1,
                        Lc = null,
                        uc = new Hza(a, Ea => pza(z, Ea, {
                            LL: Cc,
                            lB: !0
                        })),
                        gb = uc.Sh,
                        Be = () => {
                            gd || (gd = !0, ac && ac(), d && d.rh ? .remove(), Lc && (gb.ym(Lc), Lc = null), p.Wn(122447, 0))
                        },
                        Id = Ea => {
                            a.get("tilesloading") !== Ea && a.set("tilesloading", Ea);
                            Ea ||
                                (Be(), _.Tm(a, "tilesloaded"))
                        },
                        Ie = Ea => {
                            Id(!Ea.MC);
                            Ea.MC && p.Wn(211242, 0);
                        ...
                        Ha = _.xx();
                    q.then(() => {
                        new Iza(a, a.get("mapId"), Ha)
                    });
                    m.wh.then(Ea => {
                        uya(Ea, a, m)
                    });
                    Promise.all([m.wh, m.qh.nE]).then(([Ea]) => {
                    ...
                    m.wh.then(Ea => {
                        ...
                        ab === "VECTOR" ? (_.M(a, 150152), _.dl("webgl").then(zb => {
                            var hb = !1,
                                ...
                                hc = Ma;
                            hxa() && (fc = null, hc = void 0);
                            try {
                                var od = zb.zh(z.Up, Ie, gb, Na.sh, Ea, _.fl.rh(), fc, _.yx(Ha, !0), a, hc, je, Vd)
                            } catch (jd) {
                                let nb = jd.cause;
                                jd instanceof _.dsa && (nb = 1E3 + (_.Fl(jd.cause) ?
                                    jd.cause : -1));
                                _.kl(ud, nb != null ? nb : 2);
                                hb = !0
                            } finally {
                                hb ? (m.Dz(!1), _.Nl("Attempted to load a Vector Map, but failed. Falling back to Raster. Please see https://developers.google.com/maps/documentation/javascript/webgl/support for more info")) : (_.kl(ud, 0), (0, _.Yra)() || _.M(a, 212143), m.Dz(!0), m.jk = od, m.set("configVersion", od.zh()), gb.lF(od.Ah()))
                            }
                        })) : m.Dz(!1)
                    });
                    m.sh.then(Ea => {
                        ...
                        qya(Na, Ea);
                        if (Ea) _.Vu(Na.sh, ab => {
                            ab ? Ud.clear() : _.Dx(Ud, Na.xh.get())
                        });
                        else {
                            let ab = null;
                            _.Vu(Na.xh, zb => {
                                ab !== zb && (ab = zb, _.Dx(Ud, zb))
                            })
                        }
                    });
                    ...
                    Md.bindTo("tilt", a);
                    Md.bindTo("zoom", a);
                    Md.bindTo("mapTypeId", a);
                    Md.bindTo("aerial", ia.obliques, "available");
                    Promise.all([m.sh, m.wh]).then(([Ea, ab]) => {
                        ...
                        var zb = () => {
                            ...
                            fc && _.M(a, 150938);
                            var ud = gb;
                            de.Ej.zs = new Mza(ud, f, de, hb, fc, Sc, RD);
                            hb || fc ? de.Ej.JJ = new Nza(ud, de, hb, fc, Sc, RD) : de.Ej.JJ = void 0
                        };
                        zb();
                        a.addListener("tiltinteractionenabled_changed", zb);
                        a.addListener("headinginteractionenabled_changed", zb)
                    });
                    m.bindTo("tilt", Md, "actualTilt");
                    _.Hm(Ga, "attributiontext_changed", () => {
                        a.set("mapDataProviders",
                            Ga.get("attributionText"))
                    });
                    var Oa = new Oza;
                    _.dl("util").then(Ea => {
                        Ea.Zq.qh(() => {
                    ...
                    Oa.bindTo("styles", a);
                    Oa.bindTo("mapTypeId", Na);
                    Oa.bindTo("mapTypeStyles", Na, "styles");
                    m.bindTo("apistyle", Oa);
                    m.bindTo("isLegendary", Oa);
                    m.bindTo("hasCustomStyles", Oa);
                    _.Sm(Oa, "styleerror", a);
                    e = new Pza(m.Tl);
                    e.bindTo("tileMapType", Na);
                    m.bindTo("style", e);
                    var db = new _.EA(a, gb, () => {
                            var Ea = m.set,
                                ab;
                            if (db.bounds && db.origin && db.scale && db.center && db.size) {
                                if (ab = db.scale.qh) {
                                    var zb = ab.xo(db.origin,
                                        db.center, _.cv(db.scale), db.scale.tilt, db.scale.heading, db.size);
                                    ab = new _.En(-zb[0], -zb[1]);
                                    zb = new _.En(db.size.Xh - zb[0], db.size.Zh - zb[1])
                                } else ab = _.bv(db.scale, _.Zu(db.bounds.min, db.origin)), zb = _.bv(db.scale, _.Zu(db.bounds.max, db.origin)), ab = new _.En(ab.Xh, ab.Zh), zb = new _.En(zb.Xh, zb.Zh);
                                ab = new _.$n([ab, zb])
                            } else ab = null;
                        ...
                        Fc = db;
                    gb.Qj(db);
                    m.set("projectionController", db);
                    m.set("mouseEventTarget", {});
                    (new Qza(z.Up)).bindTo("title", m);
                    d && (_.Vu(d.sh, () => {
                        var Ea = d.sh.get();
                        Lc || !Ea || gd || (Lc = new _.gsa(B, -1, Ea, gb.topology), d.rh ? .remove(), gb.Qj(Lc))
                    }), d.bindTo("tilt", m), d.bindTo("size", m));
                    m.bindTo("zoom", a);
                    m.bindTo("center", a);
                    m.bindTo("size", L);
                    m.bindTo("baseMapType", Na);
                    a.set("tosUrl", _.Vra);
                    e = new Rza;
                    ...
                    m.sh.then(Ea => {
                        id.sh = Ea ? 2 : 1;
                        if (id.rh !== void 0 || id.qh !==
                            void 0) id.moveCamera({
                            tilt: id.rh,
                            heading: id.qh
                        }), id.rh = void 0, id.qh = void 0
                    });
                    var kc = new Tza(gb, a);
                    kc.bindTo("mapTypeMaxZoom", Na, "maxZoom");
                    kc.bindTo("mapTypeMinZoom", Na, "minZoom");
                    kc.bindTo("maxZoom", a);
                    kc.bindTo("minZoom", a);
                    ...
                    a.yE || (ac = () => {
                        ac = null;
                        Promise.all([_.dl("controls"), m.sh, m.wh]).then(([Ea, ab, zb]) => {
                            var hb = z.qh,
                                fc = new Ea.jG(hb, a.zt());
                            ...
                            var ud = ab && wza(a, zb);
                            zb = ab && xza(a, zb);
                            Ea.tO(fc, a, Na, hb, Ga, ia.report_map_issue, kc, Md, z.Ys, c, m.en, ha, Fc, gb, ab, ud, zb, x);
                            Ea.uO(a, z.Lj, hb, O, ud, zb);
                            Ea.qF(c)
                        })
                    }, _.M(a, 150182), tza(a, Na), iya(a), _.Tm(m, "mapbindingcomplete"));
                    e = new Gza(_.wg(_.fl, _.wx, 2), _.Pu(),
                        _.fl.rh(), a, new QD(ha, Ea => Ra ? Ma : Ea || La), ia.obliques, m.qh);
                    Uya(e, a.overlayMapTypes);
                    aya(Ea => {
                        _.M(a, Ea)
                    }, z.mn.mapPane, a.overlayMapTypes, gb, b, xb);
                    ...
                    td.frameBorder = "0";
                    td.tabIndex = -1;
                    td.style.cssText = "z-index: -1; position: absolute; width: 100%;height: 100%; top: 0; left: 0; border: none; opacity: 0";
                    _.Nm(td, "load", () => {
                        h();
                        _.Nm(td.contentWindow, "resize",
                            h)
                    });
                    z.qh.appendChild(td);
        ...
        aE = class extends ID {
            constructor(a, b, c, d, e, f) {
                super(a.xh, a.yh, a.projection, a.maxZoom, a.name, a.alt, a.zh, a.Jw, a.__gmsd, a.mapTypeId, a.mj, a.rh, a.language, a.region, a.heading, a.map);
                this.wh = Cxa(this.mapTypeId, this.__gmsd, b, e, f);
                this.nw && this.mapTypeId === "satellite" || this.th.set(Axa(this.language, this.region, this.mapTypeId, this.rh, this.__gmsd, b, c, d, e, !!this.map ? .get("mapId"), f, this.nw))
            }
        },
        Vza = class {
            ...
            qm(a, b) {
                a: {
                    ...
                    if (!(c < 7)) {
                        ...
                        d = a.ni / d;
                        for (e of Xza)
                            if (c >= e.rC && c <= e.qC && d >= e.uC && d <= e.tC) {
                                var e = !0;
                                break a
                            }
                    }
                ...
                return e ? this.qh.qm(a, b) : this.rh.qm(a, b)
            }
        },
        Gza = class {
    ...
    var Jza = class {
        constructor(a, b, c, d) {
            ...
            _.Ww(c.Ys, {
                ...
                ct: e => {
                    this.Sh.VA() || (this.rh = e, Date.now() - this.sh > 5 && Qxa(this))
                },
                vm: e => {
    ...
    var aAa = class extends _.kt {
        constructor(a) {
            ...
            this.kB && this.label || (this.kB ?
                this.element.setAttribute("aria-labelledby", this.kB) : this.label && this.element.setAttribute("aria-label", this.label));
            ...
            this.cC && _.Sm(this, "hide", this.cC);
            this.yi(a,
        ...
        zh(a) {
            ...
            if (this.ownerElement.contains(this.element)) {
                ...
                var b = KD(this, document.body),
                    c = a.target,
                    d = Uxa(this, b);
                a.target === this.qh ? (c = d.LN, a = d.MD, d = d.kI, this.element.contains(this.sh) ? (--c, c >= 0 ? LD(b[c]) : LD(b[d - 1])) : LD(b[a + 1])) : a.target === this.rh ? (c = d.MD, a = d.kI, d = d.MN, this.element.contains(this.sh) ? (d += 1, d < b.length ? LD(b[d]) : LD(b[c + 1])) : LD(b[a - 1])) : (d = d.MD, this.ownerElement.contains(c) && !this.element.contains(c) && LD(b[d + 1]))
            }
        }
        yh(a) {
            (a.key ===
    ...
    var QD = class {
        ...
        kE(a) {
            return this.transform(this.qh.kE(a))
        }
        xD(a) {
            return this.transform(this.qh.xD(a))
        }
        zj() {
            return this.qh.zj()
        }
    ...
    var oya = class extends _.Vm {
        ...
        rh(a) {
            ...
            c && c === this.zh || (this.wh && (_.Jm(this.wh), this.wh = null), a && (this.wh = _.Hm(this.Py, a.toLowerCase() + "_changed", this.rh.bind(this, a))), c && c instanceof _.dt ? (a = c.rh, this.set("styles", c.get("styles")), this.set("baseMapType", this.Py.get(a))) : (this.set("styles", null), this.set("baseMapType", c)), this.set("maxZoom", c && c.maxZoom), this.set("minZoom", c && c.minZoom), this.zh = c)
        }
        Ah(a, b, c, d, e, f, g) {
            ...
            if (d instanceof ID) {
                ...
                if (a = this.qh instanceof aE)
                    ...
                    if (b = a.heading === d.heading && a.projection === d.projection && a.Jw === d.Jw) a = a.th.get(), b = d.th.get(), b = a == b ? !0 : a && b ? a.scale == b.scale && a.Aq == b.Aq && (a.Po == b.Po ? !0 : a.Po && b.Po ? _.mv(a.Po, b.Po) : !1) : !1;
                    a = b
                } else a = !1;
    ...
    var Hza = class extends _.Vm {
        constructor(a, b) {
            ...
            this.Sh = b((d, e) => {
                ...
                this.Zw && e.min.equals(this.Zw.min) && e.max.equals(this.Zw.max) || (this.Zw = e, this.rh());
                if (!this.qh) {
                    this.qh = !0;
                    try {
    ...
    var fAa = class {
        constructor(a, b, c, d, e = !1) {
            ...
            this.bounds = a && {
                ...
                RT: a.max.qh - a.min.qh,
                ST: a.max.rh - a.min.rh
            };
    ...
    var Tza = class extends _.Vm {
        ...
        update() {
            ...
            this.Sh.jF(d);
            this.set("zoomRange", new _.DA(d.zu().min, d.zu().max));
    ...
    var Aza = class {
        constructor(a) {
            ...
            this.Fh = d => {
                ...
                if (f.Yk) d.key === "Escape" && f.SA(d);
                    ...
                    d.altKey && (_.ey(d) || d.key === _.Lra) ? f.hv(d) : !d.altKey && _.ey(d) && (g = !0, f.TA(d));
            ...
            var b = _.lw(),
                c = () => {
                    for (let d of this.zh) $D(this, d), d.targetElement && (d.Do &&
                        (d.oI(this.Rr) || d.Yk) && (d.targetElement.addEventListener("focusin", this.Dh), d.targetElement.addEventListener("focusout", this.Eh), d.targetElement.addEventListener("keydown", this.Fh), this.qh.set(d.targetElement, d)), d.Cz(), this.Ah = _.mp(d.Ir())), ZD(this, d);
                    this.zh.clear()
                };
            this.Jh = d => {
                this.zh.add(d);
        ...
        set Nh(a) {
            ...
            a.addEventListener("click", b => {
                var c = b.target;
                _.Mv(b) || _.Wt(b) || !this.qh.has(c) || this.qh.get(c).Au(b)
            })
        }
        Gh(a) {
            if (!this.yh.has(a)) {
    ...
    var Kza = class {
        constructor(a) {
            this.container = a;
            this.rh = 0;
            this.nv = document.createElement("p");
            a.appendChild(this.nv);
            _.Wv(a, "gm-style-moc");
            _.Wv(this.nv, "gm-style-mot");
            _.xt(gAa, a);
    ...
    var cza = class {
        ...
        gn(a) {
            if (this.active) {
                a = this.active.iP + (a.Hj.clientY - this.active.origin.clientY) / 128;
                var {
                    center: b,
                    heading: c,
                    tilt: d
    ...
    var Mza = class {
        ...
        hn(a, b) {
            ...
            if (d !== "none" && (d !== "cooperative" || !c))
                if (b.stop(), this.active) {
                    if (c = dE(this, a), this.qh = this.active.kp = c, this.sh = 0, this.rh = a.zq, this.active.pu === 2 || this.active.pu === 3) this.active.pu = 0
                ...
                if (b !== "none") {
                    ...
                    if (e === 1 || e === 2 || e === 3) d = e;
                        ...
                        if (e = this.wh) a.Mo !== 2 ? e = !1 :
                            (e = Math.abs(d.ou - a.ou) || 1E-10, e = f >= (b === "cooperative" ? 10 : 5) && a.ou >= 50 && f / e >= .9 ? !0 : !1);
                        d = e ? 3 : this.xh && (b === "cooperative" && a.Mo !== 3 || b === "greedy" && a.Mo !== 2 ? 0 : Math.abs(d.Hj.clientY - a.Hj.clientY) >= 15 && f <= 20) ? 2 : 0
                    }
                    d !== this.active.pu && (this.active.pu = d, this.qh = dE(this, a), this.sh = 0);
                    f = c.center;
                    e = c.zoom;
                    var g = c.heading,
                        h = c.tilt;
                    switch (d) {
                        ...
                        case 3:
                            ...
                            f = cE(this.qh.lA, this.sh, this.qh.center);
                            break;
                        case 1:
                            f = b === "zoomaroundcenter" &&
                                a.Mo > 1 ? c.center : _.Zu(_.Yu(c.center, this.qh.lA), this.Sh.An(a.Hj));
                            e = this.qh.zoom + Math.log(a.radius / this.qh.radius) / Math.LN2;
                            break;
                        case 0:
                            f = b === "zoomaroundcenter" && a.Mo > 1 ? c.center : _.Zu(_.Yu(c.center, this.qh.lA), this.Sh.An(a.Hj))
                    }
                    this.rh = a.zq;
                    this.active.Cp.jr({
                        center: f,
        ...
        Gn() {
            this.th(3);
            this.cursor && _.ny(this.cursor, !1);
            this.active && (this.No(this.active.pu), this.active.Cp.release(this.qh ? this.qh.lA : void 0));
            this.qh = this.active = null;
            this.sh = this.rh = 0
        }
    };
            ...
            constructor(a, b, c) {
                ...
                if (this.qh.zoom < this.gj.zoom)
                    for (;;) {
                        ...
                        this.Ku.push(Math.abs(b - this.qh.zoom) / Math.abs(this.gj.zoom - this.qh.zoom) * this.tk)
    ...
    var nza = class {
            ...
            qj(a) {
                ...
                a >= this.qh ? a = {
                    ...
                    camera: this.Il.qj(this.Il.tk - (a < b.sh ? (1 - Math.cos(a * b.qh)) * b.speed / b.qh : b.rh + b.speed * (a - b.sh)))
                });
                return a
            }
        },
    ...
    var jAa = class {
        ...
        wh() {
            return this.instructions ? this.instructions.Il ? this.instructions.Il.gj : null : this.camera
        }
        VA() {
        ...
        jF(a) {
            ...
            !this.instructions && this.camera && (a =
                this.qh.Dw(this.camera), a.center === this.camera.center && a.zoom === this.camera.zoom && a.heading === this.camera.heading && a.tilt === this.camera.tilt || this.rh(gza(a)))
        }
        zu() {
            return this.qh.zu()
        }
        ...
        rh(a) {
            ...
            this.instructions = a;
            this.th = !0;
            (a = a.Il) && this.sh(this.qh.Dw(a.gj));
            eE(this)
        }
        Wy() {
            this.ei.Wy();
            this.instructions && this.instructions.Il ? this.sh(this.qh.Dw(this.instructions.Il.gj)) : this.camera && this.sh(this.camera)
        }
    };
    var mza = class {
        constructor(a, b, c) {
            ...
            this.sh = a.Kq;
            this.xh = _.Gx();
            this.options.lB && (this.sh.style.willChange = this.th.style.willChange = "transform")
        }
        Qj(a) {
            var b = _.kb(a);
            if (!this.ei[b]) {
        ...
        getBounds(a, {
            ...
            if (this.rh) {
                ...
                g += f.height / 2;
                d += f.height / 2;
                f = this.rh.Fw(c, g, k, m, p, a, h);
                b = this.rh.Fw(c, d, k, m, p, a, h);
                c = this.rh.Fw(e, g, k, m, p, a, h);
                e = this.rh.Fw(e, d, k, m, p, a, h)
        ...
        An(a) {
            ...
            if (this.qh) {
                ...
                return this.rh ? this.rh.Fw(a.clientX - b.left, a.clientY - b.top, this.qh.center, _.cv(this.qh.scale), this.qh.scale.tilt, this.qh.scale.heading, c) : _.Yu(this.qh.center, _.Bp(this.qh.scale, {
            ...
            release(a) {
                ...
                if (!(this.history.length <= 0) && this.qh) {
                    ...
                    switch (kza(this, c.camera, a)) {
                        case 3:
                            a = new kAa(this.qh.camera, -180 + _.Fv(this.qh.camera.heading - c.camera.heading - -180, 360), d, b, a || this.qh.camera.center);
                            break;
                        case 2:
    ...
    var lza = class {
        ...
        GF(a, b = !1, c = !1) {
            return this.qh.GF(a, b, c)
        }
        tm() {
            return this.controller.tm()
        }
        pD(a, b) {
        ...
        EK(a, b) {
            var c = () => {},
                d;
            if (d = iza(this.controller) === 0 ? hza(this.controller) : this.tm()) {
                a = d.zoom + a;
                var e = this.controller.zu();
                a = Math.min(a, e.max);
                a = Math.max(a, e.min);
                e = this.wh();
        ...
        lF(a) {
            this.controller.lF(a)
        }
        VA() {
            return this.controller.VA()
        }
        Wy() {
            this.controller.Wy()
        }
